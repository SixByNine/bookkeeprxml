 ...
 * @author kei041
 */
public class ArchivedStorageWriteIndex extends Index<ArchivedStorageWrite> implements XMLAble{



    public void addArchivedStorageWrite(ArchivedStorageWrite obj) {
        this.addItem(obj);
    }

    public List<ArchivedStorageWrite> getArchivedStorageWriteList() {
    ...
    static {
        xmlSubObjects.add("ArchivedStorageWrite");
