 ...
 * @author kei041
 */
public class CandidateListIndex extends Index<CandidateListStub>{

    
    public List<CandidateListStub> getCandidateListStubList() {
        return this.getIndex();
    }

    public void addCandidateListStub(CandidateListStub obj) {
        this.addItem(obj);
    }
    ...
    static {
        xmlSubObjects.add("CandidateListStub");
