 ...
 * @author kei041
 */
public class RawCandidateIndex extends Index<RawCandidateStub>{

    public List<RawCandidateStub> getRawCandidateStubList() {
        return this.getIndex();
    }

    public void addRawCandidateStub(RawCandidateStub obj) {
        this.addItem(obj);
    }
    ...
    static {
        xmlSubObjects.add("RawCandidateStub");
