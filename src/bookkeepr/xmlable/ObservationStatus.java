 ...
 * @author kei041
 */
public class ObservationStatus implements XMLAble {

    ArrayList<ObservationConfigStatus> configStatus = new ArrayList<ObservationConfigStatus>();

    public List<ObservationConfigStatus> getObservationConfigStatusList() {
        return configStatus;
    }

    public void addObservationConfigStatus(ObservationConfigStatus o) {
        configStatus.add(o);
    }
    ...
    static {
        xmlSubObjects.add("ObservationConfigStatus");
    }
}
