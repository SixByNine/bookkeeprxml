 ...
 * @author kei041
 */
public class ConfigurationIndex extends Index<Configuration> implements XMLAble {
    ...
    public void addConfiguration(Configuration obj) {
        this.addItem(obj);
    }
    ...
    static {
        xmlSubObjects.add("Configuration");
