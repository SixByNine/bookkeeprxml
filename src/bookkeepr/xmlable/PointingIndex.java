 ...
 * @author kei041
 */
public class PointingIndex extends Index<Pointing> implements XMLAble{



    public List<Pointing> getPointingList() {
        return this.getIndex();
    }

    public void addPointing(Pointing obj) {
        this.addItem(obj);
    }
