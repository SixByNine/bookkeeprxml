 ...
 * @author kei041
 */
public class ViewedCandidatesIndex extends Index<ViewedCandidates> implements XMLAble {

    public List<ViewedCandidates> getViewedCandidatesList() {
        return this.getIndex();
    }

    public void addViewedCandidates(ViewedCandidates obj) {
        this.addItem(obj);
    }
    ...
    static {
        xmlSubObjects.add("ViewedCandidates");
